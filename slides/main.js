	...
	var htmlNodes = A2(
		...
		function (_p1) {
			return A3(
				...
				options,
				{ctor: '[]'},
				_xarvh$elm_slides$StringUnindent$unindent(_p1));
		},
		markdownFragments);
	...
	function (options, msg, oldModel) {
		...
		var mixedUpdater = F2(
			function (isAboutToChangeSlides, msg) {
				return (isAlreadyChangingSlides || isAboutToChangeSlides) ? A3(_xarvh$elm_slides$Slides$slideAnimatorUpdate, options, oldModel, msg) : A4(_xarvh$elm_slides$Slides$fragmentAnimatorUpdate, maximumPosition, options, oldModel, msg);
			});
		...
		switch (_p2.ctor) {
			...
			case 'AnimationTick':
				if (oldModel.isPaused) {
					...
					var _p3 = A2(
						mixedUpdater,
						false,
						_xarvh$elm_slides$SmoothAnimator$AnimationTick(_p2._0));
					var m = _p3._0;
					var cmd = _p3._1;
			...
			default:
				var _p4 = _xarvh$elm_slides$Slides$locationToSlideIndex(_p2._0);
				if (_p4.ctor === 'Nothing') {
					return {
						ctor: '_Tuple2',
						_0: oldModel,
						_1: _elm_lang$navigation$Navigation$modifyUrl(
							_xarvh$elm_slides$Slides$modelToHashUrl(oldModel))
					};
				} else {
					return A3(
						...
						options,
						oldModel,
						_xarvh$elm_slides$SmoothAnimator$SelectExact(_p4._0));
				}
		}
	});
...
var _xarvh$elm_slides$Slides$slideViewMotion = F2(
	function (options, model) {
		...
		var _p5 = (_elm_lang$core$Native_Utils.cmp(distance, 0) > 0) ? {ctor: '_Tuple2', _0: _xarvh$elm_slides$Slides_SlideAnimation$Outgoing, _1: _xarvh$elm_slides$Slides_SlideAnimation$Incoming} : {ctor: '_Tuple2', _0: _xarvh$elm_slides$Slides_SlideAnimation$Incoming, _1: _xarvh$elm_slides$Slides_SlideAnimation$Outgoing};
		var smallerDirection = _p5._0;
		var largerDirection = _p5._1;
		return {
			ctor: '::',
			_0: A2(
							...
							_1: {
								...
								_0: function (_p6) {
									return _elm_lang$html$Html_Attributes$style(
										_rtfeldman$elm_css$Css$asPairs(_p6));
								}(
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$width(
												...
												_0: _rtfeldman$elm_css$Css$transforms(
													{
														...
														_1: {
															...
															_0: _rtfeldman$elm_css$Css$scale(
																A2(_xarvh$elm_slides$Slides$scale, options, model)),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
...
var _xarvh$elm_slides$Slides$Model = F5(
	function (a, b, c, d, e) {
...
var _xarvh$elm_slides$Slides$keyPressDispatcher = F2(
	function (keyCodeMap, keyCode) {
		...
		while (true) {
			...
			if (_p8.ctor === '::') {
				var _p9 = _p8._0;
				if (A2(_elm_lang$core$List$member, keyCode, _p9.keyCodes)) {
					return _p9.msg;
				} else {
					var _v4 = _p8._1,
						_v5 = keyCode;
		...
		return _elm_lang$core$Platform_Sub$batch(
			{
				...
				_1: {
					...
					_0: _elm_lang$mouse$Mouse$clicks(
						A2(_xarvh$elm_slides$Slides$mouseClickDispatcher, options, model)),
					_1: {
						ctor: '::',
...
var _AronNovak$travis_video$Main$main = A2(
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _AronNovak$travis_video$Main$main !== 'undefined') {
    _AronNovak$travis_video$Main$main(Elm['Main'], 'Main', undefined);
}
